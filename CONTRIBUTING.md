...
Thank you for your interest in `strong-control-channel`, an open source project
administered by StrongLoop.

Contributing to `strong-control-channel` is easy. In a few simple steps:
  ...
  * Sign the [Contributor License Agreement](https://cla.strongloop.com/agreements/strongloop/strong-control-channel)
